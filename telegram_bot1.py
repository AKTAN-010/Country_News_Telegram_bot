...
def knopka(message):
    ...
    markup.add(item1)
    bot.send_message(message.chat.id,'нажмите на кнопку "новости"', parse_mode="html", reply_markup=markup)
...
def buttons(message):
    if message.text == "новости":
        ...
        bot.send_message(message.chat.id, "я не понял что вы имели ввиду")
